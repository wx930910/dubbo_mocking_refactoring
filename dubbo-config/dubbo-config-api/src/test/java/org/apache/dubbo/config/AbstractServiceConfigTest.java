...
public class AbstractServiceConfigTest {
	...
	public void testVersion() throws Exception {
		AbstractServiceConfig serviceConfig = new MockServiceConfig().instance;
	...
	public void testDocument() throws Exception {
		...
		assertThat(serviceConfig.getDocument(),
				equalTo("http://dubbo.apache.org"));
		Map<String, String> parameters = new HashMap<String, String>();
		AbstractServiceConfig.appendParameters(parameters, serviceConfig);
		assertThat(parameters,
				hasEntry("document", "http%3A%2F%2Fdubbo.apache.org"));
	}
	...
	public void testProtocol() throws Exception {
		...
		serviceConfig.setProtocols(new ArrayList<>(
				Collections.singletonList(new ProtocolConfig())));
	...
	public void testFilter() throws Exception {
		...
		AbstractServiceConfig.appendParameters(parameters, serviceConfig);
		assertThat(parameters,
				hasEntry(SERVICE_FILTER_KEY, "prefilter,mockfilter"));
	}
	...
	public void testListener() throws Exception {
		...
		assertThat(serviceConfig.getListener(),
				equalTo("mockexporterlistener"));
		Map<String, String> parameters = new HashMap<String, String>();
		parameters.put(EXPORTER_LISTENER_KEY, "prelistener");
		AbstractServiceConfig.appendParameters(parameters, serviceConfig);
		assertThat(parameters, hasEntry(EXPORTER_LISTENER_KEY,
				"prelistener,mockexporterlistener"));
	}
